编码规范： 1.编码格式统一为UTF-8； 2.常用shift+ctrl+f格式化代码； 3.代码格式化宽度为200； 4.图片文件，存放在drawable-xxx文件夹内；图标存在mipmap-xxx文件夹内； 5.经常保存； 6.尽量使用真机调试； 7.不定期的查看as以及sdk更新，尽量使用最新版本进行开发。
