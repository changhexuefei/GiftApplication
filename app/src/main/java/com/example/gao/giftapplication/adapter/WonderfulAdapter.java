...
public class WonderfulAdapter extends CommonAdapter<Wonderful.DataBean.ItemsBean> {
    ...
    @Override
    protected void convert(ViewHolder holder, final Wonderful.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void getAuthorInfo(Wonderful.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(Wonderful.DataBean.ItemsBean itemsBean) {
