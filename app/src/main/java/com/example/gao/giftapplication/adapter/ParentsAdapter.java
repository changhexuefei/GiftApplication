...
public class ParentsAdapter extends CommonAdapter<Parents.DataBean.ItemsBean> {
    public ParentsAdapter(Context context, int layoutId, List<Parents.DataBean.ItemsBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, final Parents.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToPage(Parents.DataBean.ItemsBean itemsBean) {
