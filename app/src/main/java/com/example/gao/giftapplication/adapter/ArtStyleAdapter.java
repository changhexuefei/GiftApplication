...
public class ArtStyleAdapter extends CommonAdapter<ArtStyle.DataBean.ItemsBean> {
    public ArtStyleAdapter(Context context, int layoutId, List<ArtStyle.DataBean.ItemsBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, final ArtStyle.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void getAuthorInfo(ArtStyle.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(ArtStyle.DataBean.ItemsBean itemsBean) {
