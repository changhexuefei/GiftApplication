...
public class SelectionAdapter extends CommonAdapter<Selection.DataBean.ItemsBean> {
    ...
    private void jumpToColumnPage(Selection.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(Selection.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(Selection.DataBean.ItemsBean itemsBean) {
