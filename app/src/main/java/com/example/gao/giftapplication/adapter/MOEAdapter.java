...
public class MOEAdapter extends CommonAdapter<MOE.DataBean.ItemsBean> {
    public MOEAdapter(Context context, int layoutId, List<MOE.DataBean.ItemsBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, final MOE.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToColumnPage(MOE.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(MOE.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(MOE.DataBean.ItemsBean itemsBean) {
