...
public class DesignAdapter extends CommonAdapter<Design.DataBean.ItemsBean> {
    public DesignAdapter(Context context, int layoutId, List<Design.DataBean.ItemsBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, final Design.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToColumnPage(Design.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(Design.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(Design.DataBean.ItemsBean itemsBean) {
