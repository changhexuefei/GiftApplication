...
public class ScienceAdapter extends CommonAdapter<Science.DataBean.ItemsBean> {
    public ScienceAdapter(Context context, int layoutId, List<Science.DataBean.ItemsBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, final Science.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToColumnPage(Science.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(Science.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(Science.DataBean.ItemsBean itemsBean) {
