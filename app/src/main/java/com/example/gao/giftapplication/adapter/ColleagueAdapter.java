...
public class ColleagueAdapter extends CommonAdapter<Colleague.DataBean.ItemsBean> {
    ...
    @Override
    protected void convert(ViewHolder holder, final Colleague.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToColumnPage(Colleague.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(Colleague.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(Colleague.DataBean.ItemsBean itemsBean) {
