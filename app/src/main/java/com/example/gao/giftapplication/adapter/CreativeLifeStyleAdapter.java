...
public class CreativeLifeStyleAdapter extends CommonAdapter<CreativeLifeStyle.DataBean.ItemsBean> {
    ...
    @Override
    protected void convert(ViewHolder holder, final CreativeLifeStyle.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToColumnPage(CreativeLifeStyle.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(CreativeLifeStyle.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(CreativeLifeStyle.DataBean.ItemsBean itemsBean) {
