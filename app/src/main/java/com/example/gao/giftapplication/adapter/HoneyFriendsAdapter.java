...
public class HoneyFriendsAdapter extends CommonAdapter<HoneyFriends.DataBean.ItemsBean> {
    public HoneyFriendsAdapter(Context context, int layoutId, List<HoneyFriends.DataBean.ItemsBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, final HoneyFriends.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToColumnPage(HoneyFriends.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(HoneyFriends.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(HoneyFriends.DataBean.ItemsBean itemsBean) {
