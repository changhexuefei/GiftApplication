...
public class BabyAdapter extends CommonAdapter<Baby.DataBean.ItemsBean> {
    public BabyAdapter(Context context, int layoutId, List<Baby.DataBean.ItemsBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, final Baby.DataBean.ItemsBean itemsBean, int position) {
    ...
    private void jumpToColumnPage(Baby.DataBean.ItemsBean itemsBean) {
    ...
    private void getAuthorInfo(Baby.DataBean.ItemsBean itemsBean) {
    ...
    private void jumpToPage(Baby.DataBean.ItemsBean itemsBean) {
